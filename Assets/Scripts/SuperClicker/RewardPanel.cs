...
public class RewardPanel : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI t_blob;
    [SerializeField] private TextMeshProUGUI t_bebe;
    ...
    public void RewardPrimerBlob()
    {
        t_blob.color = Color.yellow;
    }
    public void RewardPrimerBebe()
    {
        if (t_bebe != null)
        {
            t_bebe.color = Color.yellow;
        }
        else
        {
            Debug.LogError("t_bebe no está asignado en RewardPanel");
        }
    }
